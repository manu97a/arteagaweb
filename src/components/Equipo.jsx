...
const Equipo = () => {
  return (
    <div className="container max-w-full max-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 bg-gray-200">
      <h3 className="py-4 px-2 text-3xl font-principal text-center text-[#C2391B] drop-shadow-xl">
        Nuestro Equipo
      </h3>
      <p className="p-7 text-xl font-principal text-gray-900 text-center drop-shadow-lg">
        Lutieres de amplia experiencia en la elaboración a mano de instrumentos musicales de cuerda frotada y pulsada.
      </p>
          ...
          {equipoTrabajo.map((equipo) => (
            <div class="shadow-card flex flex-col rounded-xl bg-white bg-clip-border">
              ...
              <div class="text-secondary flex-1 p-6">
                  ...
                  <h4 class="font-principal text-gray-900 text-2xl drop-shadow-xl">{equipo.name}</h4>
